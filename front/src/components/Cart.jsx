    ...
    <>
      <Col xs={4}>
        ...
        >
          ...
          <Card.Body>
            ...
            <Card.Title>
              Total de compra : {totalCompra ? totalCompra : 0}$
            </Card.Title>
            <Link to="/car/checkout">
              <Button
                variant="outline-success"
                disabled={products[0] ? false : true}
              >
      ...
      <Col xs={8}>
        {products &&
          products.map((prod) => {
            return (
              <Row className="car-prod" key={prod.id}>
                <Col xs={4}>
                  <Image
                    className="car-img2"
                  ...
                  <ListGroup variant="flush">
                    ...
                    <ListGroup.Item>
                      <Button
                        ...
                        onClick={() => removeHandler(user.id, prod.id)}
                      >
